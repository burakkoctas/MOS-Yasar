// Path: src/features/request/components/StatusBadge.tsx
...
export default function StatusBadge({ status, fullWidth }: StatusBadgeProps) {
  const getBadgeStyle = () => {
    switch (status?.toLowerCase()) {
      case 'onaylandı': return { bg: '#E8F5E9', text: '#2E7D32' };
      case 'onay bekliyor': return { bg: '#FFF3E0', text: '#EF6C00' };
